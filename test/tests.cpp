...
TEST(tplab5, test3)
{
	...
	EXPECT_EQ(imikn.search_group_name("18ПИ-1")->get_title(), "18ПИ-1");
}
...
TEST(tplab5, test4)
{
	...
	imikn.add_student_to_group("Яковлев Андрей Михайлович", "18ПИ-1");
	imikn.add_student_to_group("Шубин Константин Алексеевич", "18ПМИ-1");
	Group* pi18_1 = imikn.search_group_name("18ПИ-1");
	for (int i = 1; i < 10; i++)
		imikn.add_mark_to_student("18ПИ-1", "Яковлев Андрей Михайлович", i);
	EXPECT_EQ(pi18_1->search_student_name("Яковлев Андрей Михайлович").avg_mark(), 5);
}
